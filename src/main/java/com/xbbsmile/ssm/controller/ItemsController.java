package com.xbbsmile.ssm.controller;
...
import com.xbbsmile.ssm.po.ItemsQueryVo;
...
//		return "redirect:queryItems.action";
	...
	@RequestMapping("/test")
	public ModelAndView test(int id, String str, @RequestParam(value="hehe",required=true) String h, Items item, ItemsQueryVo itemsQueryVo) throws Exception{
